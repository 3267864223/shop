				...
				if(result==true){
					...
					if(result==true){
						$.ajax({
							type:"post",
							url:"CateServlet.do",
							data:{flag:"update1",cateId:$("#cateId").val(),cateName:$("#cateName").val(),des:$("#des").val()}, 
	 ...
	 <table class="edit_table" >
 		...
 		<tr>
		 	...
		 	<td class="td_input_short"> 
		 		<input type="text" class="txtbox" id="cateName" name="cateName" value="${cateName}" /> 
		 	</td>   
		 	<td>
 		...
 		<tr>
 			...
 			<td><textarea rows="4" cols="27" name="des" id="des">${des}</textarea> </td>	
 			<td><label></label></td>	
 		</tr>
 		<tr>
 			<td class="td_info"> </td>	
