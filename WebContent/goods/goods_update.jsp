	 ...
	 <table class="edit_table" >
		...
		<tr >
			...
			<td>
				...
				<img id="preview"  style="width:100px;height:125px" src="GoodsServlet.do?flag=showp&goodsId=${goods.id}" alt="请上传图片" />
...
$("#returnId1").val("${goods.bigCateId}");
$("#returnId2").val("${goods.smallCateId}");
